...
export const metadata: Metadata = {
  title: "Capture Studio - Professional Photography Services",
  description: "Professional photography studio specializing in portraits, weddings, events, and commercial photography. Book your session today for stunning, high-quality images.",
  keywords: ["photography studio", "professional photographer", "portrait photography", "wedding photography", "event photography", "product photography"],
  metadataBase: new URL("https://capturestudio.com"),
  alternates: {
    canonical: "https://capturestudio.com"
  },
  openGraph: {
    title: "Capture Studio - Professional Photography Services",
    description: "Professional photography studio specializing in portraits, weddings, events, and commercial photography.",
    siteName: "Capture Studio",
    images: [{
      url: "https://images.pexels.com/photos/2388569/pexels-photo-2388569.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "Capture Studio - Professional Photography Services",
    description: "Professional photography studio specializing in portraits, weddings, events, and commercial photography.",
    images: ["https://images.pexels.com/photos/2388569/pexels-photo-2388569.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
